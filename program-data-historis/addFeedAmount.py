...
def main():
    WEIGHT_FILE = '../data/berat_lobster_weekly.csv'
    EXCEL_FILE = '../data/Lobster IoT.xlsx'
    OUTPUT_FILE_RECOMMENDATIONS = '../data/feed_recommendations.csv'
    OUTPUT_FILE_INFERENSI = '../data/inferensi.csv'
